...
let main argv =
    ...
    System.Console.WriteLine("Произведение нечетных делителей числа: {0}", DivObhod x (fun x -> x%2=1) (fun x y -> x*y) 1)
    System.Console.WriteLine("Произведение четных делителей числа: {0}", DivObhod x (fun x -> x%2=0) (fun x y -> x*y) 1)
    System.Console.WriteLine("Сумма четных чисел, простых: {0}",  Obhod x (fun x y -> x+y) 0 (fun x -> x%2=0)) 
    System.Console.WriteLine("Сумма нечетных чисел, простых: {0}",  Obhod x (fun x y -> x+y) 0 (fun x -> x%2=1)) 
    0 
